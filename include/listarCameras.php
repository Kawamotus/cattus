            ...
            <a class="text-body m-5">
                <div class="card rounded-3 bg-white d-flex flex-column align-items-center shadowzinho"
                    ...
                    <div class="foto d-flex align-items-center justify-content-center"
                        ...
                        <img style="width: 15rem; height: 15rem" src="imgs/camera.png" alt="" />
                    </div>
                    <div class="nome w-100 d-flex align-items-center justify-content-center border-bottom border-top border-dark bd-highlight bg-white position-relative"
                        style="height: 4rem; margin-top: 4rem">
                        <svg class="w-100" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24">
