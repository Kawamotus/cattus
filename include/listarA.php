...
<main class="d-flex justify-content-center">
      ...
      <div class="linha1 d-flex flex-row align-items-center justify-content-between w-100 pr-5 pl-5">
        <h1 class="mt-5 mb-5">Pets Cadastrados</h1>
          ...
          <form class="d-flex flex-row" action='listarAnimaisAO.php'>
              <a style="text-decoration: none" href='listarAnimaisAO.php'>
                <button class="btn mb-2 text-white d-flex align-items-center justify-content-center"style="background-color: #aa0000; border: hidden">Organizar por ID</button>
              </a>
          </form>
        ...
        ?>
          ...
          <a class="text-body m-5" href="animal.php?id=<?=$animais->ID_Animal?>">
            <div class="card rounded-3 bg-white d-flex flex-column align-items-center shadowzinho" style="width: 20rem; height: 28rem">
              <div style="width: 20rem; height: 20rem">
                <img style="object-fit: cover;" class="rounded-2 shadowzinho" src="files/animais/<?=$animais->Img_Animal?>" alt=""/>
              </div>
              <div class="nome w-100 d-flex align-items-center justify-content-center border-bottom border-dark bd-highlight bg-white"  style="height: 4rem">
                ...
                <h3 class="d-flex align-items-center justify-content-center w-100 flex-grow-1"> <?=$animais->Nome_Animal?> </h3>
                <div class="w-100"></div>
              </div>
              <div class="sexo w-100 d-flex align-items-center justify-content-center bd-highlight bg-white rounded-4" style="height: 4rem">
                ...
                <h3 class="d-flex align-items-center justify-content-center w-100 flex-grow-1"> <?=($animais->Sexo_Animal == "1" ? "Fêmea" : "Macho")?></h3>
                <div class="w-100"></div>
            </div></div>
        </a>
...
<?php } ?>
        ...
        <section class="d-flex align-self-center mb-5">
        <?=$paginacao?>
    </section>
        </div>
      </div>
